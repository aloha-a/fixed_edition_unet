...
utils = __import__(import_path+"utils.utils", globals(), locals(), ['cvtColor', 'preprocess_input'], 0)
cvtColor = utils.cvtColor
preprocess_input = utils.preprocess_input
#from unetgputest.unet_pytorch_main_gpu.utils.utils import cvtColor, preprocess_input
